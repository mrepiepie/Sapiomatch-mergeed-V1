...
const testimonials = [
  ...
  {
    name: "Sara Chen",
    meta: "National University of Singapore - Singapore",
    image: "/imports/student_sara.png",
    quote: "The visa checker is extremely detailed. It flagged that my financial statement was short by a few days, saving me from a certain rejection. Absolutely invaluable tool."
  },
  {
    name: "Mateo Rossi",
    meta: "Politecnico di Milano - Milan, Italy",
    image: "/imports/student_mateo.png",
    quote: "The AI matching took all my constraints—budget, weather, course structure—and found three perfect matches. I got accepted into my first choice!"
  }
];

export default function LearnovaLegacySections({ setView, setSelectedCountry }) {
  ...
  isHoveredRef.current = isTestimonialHovered;
  ...
  const goToDestination = (countryName) => {
    const codeMap = {
      "Australia": "australia",
      "United Kingdom": "uk",
      "United States": "usa",
    ...
    const code = codeMap[countryName] || "australia";
  ...
  const renderVisaPanel = () => {
    if (activeVisaTab === "study") {
      return (
        <div className="learnova-visa-info-panel">
    ...
    if (activeVisaTab === "finance") {
      return (
        <div className="learnova-visa-info-panel">
          ...
          <button type="button" className={`learnova-check-row ${visaReady ? "checked" : ""}`} onClick={() => setVisaReady(!visaReady)}>
            <span />
            <div>
    ...
    return (
      <>
        <div className="learnova-visa-topline">
          <strong>Precise eligibility audit</strong>
          <span className={visaReady ? "ready" : ""}>{visaReady ? "Ready" : "Not yet ready"}</span>
        </div>
        <div className="learnova-score-row">
          <div className="learnova-score-ring">
            <b>{visaReady ? 70 : 60}</b>
            <span>{visaReady ? "100%" : "86%"}</span>
          </div>
          <div className="learnova-score-bars">
        ...
        <ul className={visaReady ? "learnova-ready-list" : ""}>
  ...
  return (
    <div className="learnova-legacy-sections">
      <section className="learnova-section learnova-find-university">
        <div className="learnova-copy">
          <h2>Find your university now</h2>
          <p>Browse our catalog of universities and programs worldwide.</p>
          <div className="learnova-select-stack">
          ...
          <button className="btn-premium learnova-wide-cta" onClick={goToMatching}>
            Start matching
          </button>
          <p className="learnova-inline-link">
            Prefer to talk first? <button type="button" onClick={() => setView("contact")}>Book a consultation <ArrowRight size={14} /></button>
          </p>
        </div>
        <div className="learnova-laptop-wrap">
          <img src="/imports/dashboard_mockup_wide.png" alt="Learnova university search dashboard" />
        </div>
      </section>

      <section id="tutoring-matching" className="learnova-section learnova-help-section">
        ...
        <div className="learnova-pathway-tabs">
        ...
        <div className="learnova-pathway-detail">
          <div>
            <span className="learnova-eyebrow">{pathway.eyebrow}</span>
            <h3>{pathway.title}</h3>
            <p>{pathway.body}</p>
            <strong>{pathway.helper}</strong>
            <div className="learnova-chip-cloud">
          ...
          <div className="learnova-pathway-image">
      ...
      <section ref={choiceSectionRef} className="learnova-section learnova-choice-section">
        <div className="learnova-copy">
          <h2>Why students choose Learnova AI</h2>
          <p>Free to use, no middlemen, and AI-matched to you - built on real rankings, costs, and requirements.</p>
          <div className="learnova-stat-stack">
        ...
        <div className="learnova-phone-mock">
      ...
      <section id="study-destinations" className="learnova-section learnova-destinations">
        <div className="learnova-centered-heading">
        ...
        <div className="learnova-destination-grid">
          {destinations.map((destination) => (
            <button key={destination.name} type="button" onClick={() => goToDestination(destination.name)}>
      ...
      <section id="visa-readiness" className="learnova-section learnova-visa-section">
        <div className="learnova-copy">
        ...
        <div className="learnova-visa-card learnova-visa-card-legacy-hidden">
          <div className="learnova-visa-tabs">
          ...
          <div className="learnova-visa-body">
            <div className="learnova-visa-topline">
              <strong>Precise eligibility audit</strong>
              <span className={visaReady ? "ready" : ""}>{visaReady ? "Ready" : "Not yet ready"}</span>
            </div>
          ...
          <div className="learnova-visa-footer"><Zap size={20} /> We calculate your exact standing against the points-based immigration system.</div>
        </div>
        <div className="learnova-visa-card">
          <div className="learnova-visa-tabs">
            {visaTabs.map((tab) => {
              const Icon = tab.icon;
              return (
          ...
          <div key={activeVisaTab} className="learnova-visa-body learnova-visa-panel-animate">
            {renderVisaPanel()}
          </div>
          <div className="learnova-visa-footer"><Zap size={20} /> We calculate your exact standing against the points-based immigration system.</div>
        </div>
      ...
      <section id="worldwide-universities" className="learnova-section learnova-worldwide" style={{ borderTop: '1px solid var(--card-border)', background: 'rgba(255,255,255,0.01)' }}>
        <div className="learnova-centered-heading">
          <h2>Universities worldwide</h2>
          <p>UK, USA, Canada, Germany, Australia - and growing.</p>
        </div>
        <div className="uni-scroller">
          <div className="uni-logo-track">
            {[...universityLogos, ...universityLogos, ...universityLogos, ...universityLogos].map((uni, index) => (
              <div 
                key={`${uni.code}-${index}`} 
                className="uni-logo-card"
                onClick={goToExplore}
              >
                <span className="uni-logo-card-badge">{uni.country}</span>
                <span className="uni-logo-card-plus">+</span>
                <strong className="uni-logo-card-logo">{uni.code}</strong>
                <span className="uni-logo-card-name">{uni.name}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="hear-from-our-students" ref={testimonialSectionRef} className="learnova-section learnova-testimonials" style={{ borderTop: '1px solid var(--card-border)' }}>
        <div className="learnova-centered-heading">
        ...
        >
          <div 
            ...
            style={{ 
              transform: `translateX(calc(-${activeTestimonial} * var(--slide-width, 33.333%) + var(--slide-offset, 33.333%)))` 
            }}
          >
            {testimonials.map((item, index) => (
              <article 
                key={item.name} 
                className={`testimonial-card ${activeTestimonial === index ? "is-active" : ""}`}
              ...
              >
                <div className="testimonial-card-overlay">
                  ...
                  <div className="testimonial-footer">
                    ...
                    <button className="story-btn" type="button" onClick={(e) => {
                      e.stopPropagation();
                      setView("questionnaire");
                    }}>Story</button>
                  </div>
