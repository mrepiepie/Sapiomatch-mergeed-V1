...
export default function LearnovaEarthGlobe({
  instanceId = "learnova-home-globe",
  variant = "default",
  showHelper = false
}) {
  ...
  return (
    <div className={`globe-showcase-container learnova-home-globe learnova-globe-${variant}`}>
      <div className="globe-canvas-frame">
        <canvas
          ...
          width="720"
          height="720"
          aria-label="Interactive 3D Learnova study destination globe"
        />
      </div>
