...
export default function SapioLegacySections({ setView, setSelectedCountry }) {
    ...
    <div className="sapio-legacy-sections">
      <section className="sapio-section sapio-find-university">
        ...
        <div className="sapio-laptop-wrap">
          <img src="/imports/dashboard_mockup_wide.png" alt="SapioMatch university search dashboard" />
        </div>
      </section>

      <section id="tutoring-matching" className="sapio-section sapio-help-section">
      ...
      <section id="study-destinations" className="sapio-section sapio-destinations">
        <div className="sapio-centered-heading">
      ...
      <section id="visa-readiness" className="sapio-section sapio-visa-section">
        <div className="sapio-copy">
      ...
      <section id="worldwide-universities" className="sapio-section sapio-worldwide" style={{ borderTop: '1px solid var(--card-border)', background: 'rgba(255,255,255,0.01)' }}>
        <div className="sapio-centered-heading">
      ...
      <section id="hear-from-our-students" ref={testimonialSectionRef} className="sapio-section sapio-testimonials" style={{ borderTop: '1px solid var(--card-border)' }}>
        <div className="sapio-centered-heading">
